...
+++
|[[operation]]`@operation`|`link:enums.html#AclOperation[AclOperation]`|+++
Set the value for operation
+++
|[[permissionType]]`@permissionType`|`link:enums.html#AclPermissionType[AclPermissionType]`|+++
...
Set the resource name
+++
|[[patternType]]`@patternType`|`link:enums.html#PatternType[PatternType]`|+++
Set the resource pattern type
+++
|[[resourceType]]`@resourceType`|`link:enums.html#ResourceType[ResourceType]`|+++
